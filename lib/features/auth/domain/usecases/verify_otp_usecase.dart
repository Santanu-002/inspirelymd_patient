...
class VerifyOtpUseCase implements BaseUseCase<Map<String, dynamic>, VerifyOtpParams> {
  final IAuthRepository _repository;

  VerifyOtpUseCase(this._repository);

  @override
  Future<Either<AppFailure, Map<String, dynamic>>> call(VerifyOtpParams params) {
