...
class LightColors {
  ...
  final Color tonalSurface = const Color(0xFFF3F3FE);
  final Color cardSurface = const Color(0xFFFFFFFF);

  final Color brandBlue = const Color(0xFF004AC6); // Primary theme color
  ...
  final Color textDefault = const Color(0xFF191B23);
...
class DarkColors {
  ...
  final Color brandAccent = const Color(0xFF3B82F6);

  final Color error = const Color(0xFFCF6679);
  final Color pending = const Color(0xFFFEA619);
  final Color inProgress = const Color(0xFF3B82F6);
  final Color completed = const Color(0xFF03DAC6);
  final Color cancelled = const Color(0xFFCF6679);
  final Color ghostBorder = const Color(0xFF424242);
  final Color black = const Color(0xFF000000);
