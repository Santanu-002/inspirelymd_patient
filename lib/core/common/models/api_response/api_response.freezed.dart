...
mixin _$ApiResponse<T> {
 ...
 bool get success; String get message; T? get data;@JsonKey(includeFromJson: false, includeToJson: false) int? get statusCode;
...
@useResult
$Res call({
 bool success, String message, T? data,@JsonKey(includeFromJson: false, includeToJson: false) int? statusCode
});
...
/// Create a copy of ApiResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? success = null,Object? message = null,Object? data = freezed,Object? statusCode = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool success,  String message,  T? data, @JsonKey(includeFromJson: false, includeToJson: false)  int? statusCode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
return $default(_that.success,_that.message,_that.data,_that.statusCode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool success,  String message,  T? data, @JsonKey(includeFromJson: false, includeToJson: false)  int? statusCode)  $default,) {final _that = this;
switch (_that) {
case _ApiResponse():
return $default(_that.success,_that.message,_that.data,_that.statusCode);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool success,  String message,  T? data, @JsonKey(includeFromJson: false, includeToJson: false)  int? statusCode)?  $default,) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
return $default(_that.success,_that.message,_that.data,_that.statusCode);case _:
  return null;
...
class _ApiResponse<T> implements ApiResponse<T> {
  const _ApiResponse({required this.success, required this.message, this.data, @JsonKey(includeFromJson: false, includeToJson: false) this.statusCode});
...
@override@JsonKey(includeFromJson: false, includeToJson: false) final  int? statusCode;
